...
public class Messages {
    ...
    static String playerWin(Player player) {
        return String.format("com.github.martingaston.tictactoe.Player %s wins!", player.symbol().toString());
    }
    ...
    static String announcePlayerTurn(Player player) {
        return String.format("com.github.martingaston.tictactoe.Player %s's turn", player.symbol().toString());
    }
